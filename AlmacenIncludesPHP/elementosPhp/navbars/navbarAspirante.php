...
<ul id="slide-out" class="sidenav colorContrast">
    ...
    <li><?php echo "<a href='./consultarEstadoDeSolicitud.php?nombreSolicitud=$nombre' class='textColor'><i class='material-icons'>hearing</i>Lista de ofertas enviadas.</a>"?></li>
