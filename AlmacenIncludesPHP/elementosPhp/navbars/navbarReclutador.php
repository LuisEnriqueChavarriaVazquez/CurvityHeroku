...
<!--Menu del sidenav-->
<form method="get" action="ofertasPublicadasPrevioSwipe.php">
    <ul id="slide-out" class="sidenav colorContrast">
        ...
        <li><a href="gestionOfertas.php" class="textColor"><i class="material-icons">chrome_reader_mode</i>Gestionar ofertas.</a></li>
