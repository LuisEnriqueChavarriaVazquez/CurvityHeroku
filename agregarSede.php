...
<div class="boxSubjectsInicioExtended light-blue darken-4 centerElements">
    ...
    <div class="sizeCardForm backgroundCardForm borderCardInicio z-depth-3">
        <form class="col s12">
            <div class="row">
                ...
                <div class="input-field col s12">
                    <input placeholder="Escriba el email del reclutador." id="email_reclutador" type="email" class="validate white-text truncate">
                    <label for="email_reclutador">Email.</label>
                </div>
                <div class="input-field col s12">
                    <input placeholder="Asigne password de reclutador designado." id="password_reclutador" type="password" class="validate white-text truncate">
    ...
    <a href="gestionSedes.php"><button type="submit" class="waves-effect btn-large borderButton sizeButton textButton grey lighten-5 blue-text text-darken-4">Agregar sede.</button></a>
</div>
