...
if (isset($_POST['submit'])) {
    ...
    if ($contadorEleConfimados == 6) {
        ...
        $query = "INSERT INTO Sede(IDEmpresa, Nombre, Telefono, Direccion, NombreReclutador, CorreoElecReclutador,Contra,FacebookSed,SkypeSed,TwitterSed) VALUES (7,'$nombre_sede', '$tel_sede', '$direccion_sede','$nombre_reclutador','$email_reclutador','$password_reclutador', '$facebook_sede','$skype_sede','$twitter_sede')";
