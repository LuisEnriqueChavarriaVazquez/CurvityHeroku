...
<div class="boxSubjectsInicio light-blue darken-4 centerElements">
    <div class="sizeCardInicio backgroundCardInicio centerElements borderCardInicio z-depth-3">
        <form class="col s12" method="POST" action="loginEmpresa.php">
            <div class="row">
                <div class="input-field col s12">
                    <i class="material-icons prefix white-text">email</i>
                    <input id="email" name="username_emp" id="username_emp"  type="email" class="validate white-text">
                    <label for="email" class="white-text">Email.</label>
                </div>
                <div class="input-field col s12">
                    <i class="material-icons prefix white-text">lock</i>
                    <input id="password" name="password_emp" id="password_emp" type="password" class="validate white-text">
